...
import my_modes
from my_modes import BaseGameMode, MachineMonitorMode, GunMode, HockeyMode, HatTrickMode, GoalScoredMode, PowerPlayMode
...
class T2Game(SkeletonGame):
    ...
    def __init__(self):
        ...
        self.hockey_mode = HockeyMode(game=self)
        self.gun_mode = GunMode(game=self)
        self.power_play_mode = PowerPlayMode(game=self)
        self.hat_trick_mode = HatTrickMode(game=self)
        self.goal_scored_mode = GoalScoredMode(game=self)
